...
// GetConversationsPayload for call GetConversations
type GetConversationsPayload struct {
	IDUser int
}

// GetConversations return a basic response
func GetConversations(payload interface{}) interface{} {
	context := payload.(GetConversationsPayload)
